...
public class Main {
    public static void main(String[] args) {
        ...
        Agent bluePlayer = new MyAgent(game, false); // create the yellow player, any subclass of Agent
        Connect4Frame mainframe = new Connect4Frame(game, redPlayer, bluePlayer); // create the game window
    }
}
